...
const JobCard = ({ name }) => {
  return (
    <div className="p-2 max-h-[360px] hover:scale-105 transition-all rounded-2xl shadow-lg w-full sm:w-64 md:w-72 lg:w-80 min-h-[350px] justify-between bg-white flex flex-col m-2">
