        ...
        <div className="flex w-1/2 items-center p-4 flex-row-reverse">
          <Dialog>
            ...
            <DialogContent className="rounded-2xl shadow-xl w-full h-full pb-0 overflow-auto max-w-[800px]">
              <DialogHeader
                className={`px-5 md:px-7 lg:px-9 py-5 pb-5 md:py-7  `}
              >
                ...
                <DialogDescription>
                  <div>
                    <div className="grid w-full grid-cols-1 my-3 items-center md:grid-cols-[1fr_auto] h-auto md:gap-6 xl:gap-8">
                      <div className="order-2 md:order-1 max-w-xl flex flex-col justify-around items-center h-full">
                  ...
                  <div className="my-6">
                    <div className="text-foreground text-2xl leading-none bg-white h-8 sticky top-0 z-1 my-2 font-semibold">
                      Links
                    </div>
                    <Separator />
              ...
              <DialogFooter
                className={`sticky h-14 items-center bg-background bottom-0 grid grid-cols-[auto_min-content]`}
              >
                <DialogClose asChild>
                  <Button
                    variant="outline"
